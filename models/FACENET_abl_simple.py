...
feature_extractor_fn = get_feature_extractor_improved(model, use_mtcnn=False, use_augmentation=False)
...
if query_embs.shape[0] > 0 and gallery_embs.shape[0] > 0:
    ...
    submission_path = "submission/submission_facenet_abl_simple.py"
