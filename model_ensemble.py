...
def retrieve_combined(query_embs, query_files, gallery_embs, gallery_files, k=20):
...
if __name__ == "__main__":
    # MODIFICA QUI SOLO I PATH DELLE IMMAGINI
    print("let's start")
    ...
    # Concatenazione
    query_total = concatenate_embeddings(query_clip, query_dino, query_eff)
    gallery_total = concatenate_embeddings(gallery_clip, gallery_dino, gallery_eff)

    # Retrieval
    submission = retrieve_combined(query_total, query_files, gallery_total, gallery_files, k=30)

    # Salvataggio
    save_submission(submission, "submission/ensemble_submission.json")
